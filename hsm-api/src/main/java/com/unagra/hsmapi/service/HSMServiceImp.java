...
import com.unagra.hsmapi.entity.OtpToken;
import com.unagra.hsmapi.exceptions.ResourceNotFoundException;
import com.unagra.hsmapi.model.HSMResponse;
import com.unagra.hsmapi.repository.HSMRepository;
import com.unagra.hsmapi.repository.OtpTokenRepository;
import com.unagra.hsmapi.utils.AES.AlgorithAESCBC;
import com.unagra.hsmapi.utils.HSM.ValidateOTP;
...
public class HSMServiceImp implements HSMService {
    @Value("${hsm.enviormentClass}")
    public String vpuClassEnviorment;
    @Value("${hsm.enviormentOPT}")
